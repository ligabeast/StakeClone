        ...
        <div class="w-full h-full flex items-center justify-center relative">
            <div class="w-96 h-fit flex flex-col bg-gray-600 rounded-lg space-y-3 p-4 relative z-50">
                <button
                    ...
                    @click="emit('closeModal')"
                >X</button>
                <p class="font-bold text-white text-lg text-center">Sign in</p>
                ...
                <div class="flex flex-col space-y-1">
                    ...
                    <input
                        v-model="password"
                        type="password"
                        class="w-full h-10 bg-gray-700 text-white rounded-md ring-2 ring-gray-400 px-2 focus:outline-none hover:ring-gray-300 transition font-bold"
                ...
                <span class="text-white text-xs font-medium text-center hover:cursor-pointer select-none">Password
                    forget</span>
                <span class="font-medium text-gray-300 text-sm text-center select-none">No Account yet?
                    <span class="font-medium text-white hover:cursor-pointer">Create one</span>
                </span>
            </div>
        </div>
    </div>
...
const emit = defineEmits(['closeModal', 'success', 'userNotFound']);
